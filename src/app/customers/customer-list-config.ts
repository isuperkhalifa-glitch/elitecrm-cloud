...
export const customerListConfigs: Record<CustomerListView, CustomerListConfig> = {
  ...
  manual: {
    ...
    titleAr: "الإدخال اليدوي",
    titleEn: "Manual entry",
    descriptionAr: "تسجيل عميل جديد يدويًا، ثم البحث والتصفية داخل العملاء المسجلين من هذه الصفحة.",
    descriptionEn: "Create a customer manually, then search and filter customers created from this page.",
