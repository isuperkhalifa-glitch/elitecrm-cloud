...
const customerViewChildren: NavItem[] = [
  ...
  { href: "/customers/manual", ar: "بيانات المصدر اليدوي", en: "Manual-source data", icon: UsersRound, roles: allRoles },
...
export const pageTitles: Record<string, { ar: string; en: string }> = {
  ...
  customersManual: { ar: "بيانات المصدر اليدوي", en: "Manual-source data" },
