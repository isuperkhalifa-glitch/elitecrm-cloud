...
3. `v10_4_registration_integrity_v2.sql`
4. `v10_4_archive_protection.sql`
5. `v10_6_commission_engine.sql`
6. `v10_6_write_permissions.sql`
7. `v10_6_read_scope.sql`
8. `v10_7_developer_role_guard_v2.sql`

Do not run these superseded drafts:
